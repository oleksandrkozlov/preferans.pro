...
server {
    listen 80;
    listen [::]:80;
    server_name preferans.pro www.preferans.pro;

    return 301 https://preferans.pro$request_uri;
}
...
server {
    ...
    location = / {
        return 301 https://preferans.pro;
    }
    ...
    location = /prefbuff {
        return 301 https://preferans.pro/prefbuff;
    }
...
server {
    listen 443 ssl;
    listen [::]:443 ssl;
    server_name preferans.pro;

    ssl_certificate /etc/letsencrypt/live/preferans.pro/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/preferans.pro/privkey.pem;
